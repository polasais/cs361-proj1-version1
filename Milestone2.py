...
class Project1:
    ...
    def quiz(self):
        ...
        print(f"Your word is {self.word}. You can type 'Skip' to skip this word, "
              f"or 'remove' to remove it from the list of words.")
    ...
    def ask_question(self, word):
        """
        Asks the user to select which word is the correct answer.
        It then calls check_answer to check if the user's choice was accurate.
        """
    ...
    def check_answer(self, user_guess, word):
        """
        Checks if the user's guess is correct. If it's invalid, it repeats the question by calling ask_question.
        """
    ...
    def skipped_words(self):
        """Returns the list of words a user skipped."""
